import { PERMIT2_ADDRESS_BY_CHAINS } from '@derpdex/permit2-sdk'
...
export default function usePermit2Allowance(amount?: CurrencyAmount<Token>, spender?: string): Allowance {
  ...
  const permit2Address = PERMIT2_ADDRESS_BY_CHAINS[chainId ?? 280]
  ...
  const isApprovalPending = Boolean(usePendingApproval(token, permit2Address))
