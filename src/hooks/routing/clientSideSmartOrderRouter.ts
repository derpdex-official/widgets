...
import type { AlphaRouterConfig } from '@derpdex/smart-order-router'
...
} from '@derpdex/smart-order-router'
...
function getRouter(chainId: ChainId, provider: BaseProvider): AlphaRouter {
  ...
  // TODO(zzmp): Upstream to @derpdex/smart-order-router, exporting an enum of supported v2 chains for clarity.
  ...
  // TODO(zzmp): Upstream to @derpdex/smart-order-router, possibly making this easier to modify
